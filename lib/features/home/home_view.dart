...
class HomeView extends GetView<HomeController> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _buildSensorCard(context, 'Sensor Hujan', '75%', Icons.cloudy_snowing),
                      _buildSensorCard(context, 'Kelembaban Tanah', '68%', Icons.grass_outlined),
                      _buildSensorCard(context, 'Kelembaban Udara', '82%', Icons.air_outlined),
                      _buildSensorCard(context, 'Suhu Udara', '28°C', Icons.thermostat_outlined),
                    ],
                  ),
                ),
                const SizedBox(height: 20),
                            ...
                            Obx(
                              () => Text(
                                controller.upcomingSchedule.value != null
                                    ? controller.scheduleService.formatScheduleWithZone(
  ...
  Widget _buildSensorCard(BuildContext context, String title, String value, IconData icon) {
    return Container(
